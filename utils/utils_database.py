...
from controllers.session import engine
...
users = [
    ['Rémy', 'Reynaud', 'rémy.reynaud@epic-events.com', 1],
    ['Benoît', 'Marchal', 'benoît.marchal@epic-events.com', 1],
    ['Jeanne', 'Boutin', 'jeanne.boutin@epic-events.com', 1],
    ['Suzanne', 'Peron', 'suzanne.peron@epic-events.com', 1],
    ['Zoé', 'Colin', 'zoé.colin@epic-events.com', 2],
    ...
    ['Eugène', 'Chevallier', 'eugène.chevallier@epic-events.com', 3],
    ['Henriette', 'Lamy', 'henriette.lamy@epic-events.com', 3]
]

clients = [
    ['Gabriel', 'Daniel', 'gabriel.daniel@fabre.com', '05.62.43.30.49', 'Fabre', 1],
    ['Charlotte', 'Roger', 'charlotte.roger@picard.com', '03.22.16.90.63', 'Picard', 3],
    ['Nicolas', 'Diaz', 'nicolas.diaz@albert-et-fils.com', '01.80.23.32.45', 'Albert et Fils', 2],
    ['Luc', 'Delaunay', 'luc.delaunay@bruneau.com', '05.33.19.03.83', 'Bruneau', 4],
    ['Élise', 'Tanguy', 'élise.tanguy@dumas.com', '04.70.54.48.33', 'Dumas', 2],
    ['Noël', 'Da Silva', 'noël.da silva@le-goff.com', '03.58.76.69.72', 'Le Goff', 1],
    ['Valérie', 'Petitjean', 'valérie.petitjean@rémy-et-fils.com', '02.32.26.71.16', 'Rémy et Fils', 3],
    ['Nicolas', 'Torres', 'nicolas.torres@gérard.com', '05.63.24.86.03', 'Gérard', 1],
    ['Richard', 'Grenier', 'richard.grenier@navarro-vasseur.com', '07.87.39.58.05', 'Navarro Vasseur SARL', 4],
    ['Marthe', 'Merle', 'marthe.merle@nguyen.com', '03.52.82.80.92', 'Nguyen', 4]
]
