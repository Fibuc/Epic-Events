...
@click.option('--contract-id', type=int, help="Le numéro du contrat à modifier.")
...
def modify_contract(contract_id, client_id, commercial_id, total_amount, already_paid, status):
    """Modifie un contrat."""
    controller = ContractController()
